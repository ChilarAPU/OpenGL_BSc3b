...
in vec3 localPos; //world position
...
vec2 Hammersly(uint i, uint N); //low-discrepency sample for monte-carlo
...
float RadicalInverse_VdC(uint bits)
{
	//Van Der Corput sequence which mirrors decimal points in binary
